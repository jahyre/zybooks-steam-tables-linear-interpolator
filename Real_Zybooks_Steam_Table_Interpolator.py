            ...
            for i in range(len(list(psat_list))):
                if P2 == list(psat_list)[i] and h2 < (list(hfsat_list))[i]:
                    ...
                    if P2 in subcooled_pressures:
                        ...
                        v_b2, v_a2 = lb.corresponding_ab(temp, hcooled2_list, vcooled2_list)
                        u_b2, u_a2 = lb.corresponding_ab(temp, hcooled2_list, ucooled2_list)
                        t_b2, t_a2 = lb.corresponding_ab(temp, hcooled2_list, tcooled2_list)
                        s_b2, s_a2 = lb.corresponding_ab(temp, hcooled2_list, scooled2_list)
                        v2 = lb.interpolate(h2, h_b2, h_a2, v_b2, v_a2)
                        u2 = lb.interpolate(h2, h_b2, h_a2, u_b2, u_a2)
                        t2 = lb.interpolate(h2, h_b2, h_a2, t_b2, t_a2)
                        s2 = lb.interpolate(h2, h_b2, h_a2, s_b2, s_a2)
                    ...
                    if P2 in superheated_pressures:
                        ...
                        sheated2_list = lb.interpolist(pressure, pressure_below, pressure_above, list(sheatedb2_list),
                                                       list(sheateda2_list))
                        h_b2, h_a2 = lb.above_below(temp, list(hheated2_list))
                        v_b2, v_a2 = lb.corresponding_ab(temp, hheated2_list, vheated2_list)
                        u_b2, u_a2 = lb.corresponding_ab(temp, hheated2_list, uheated2_list)
                        t_b2, t_a2 = lb.corresponding_ab(temp, hheated2_list, theated2_list)
                        s_b2, s_a2 = lb.corresponding_ab(temp, hheated2_list, sheated2_list)
                        v2 = lb.interpolate(h2, h_b2, h_a2, v_b2, v_a2)
                        u2 = lb.interpolate(h2, h_b2, h_a2, u_b2, u_a2)
                        t2 = lb.interpolate(h2, h_b2, h_a2, t_b2, t_a2)
                        s2 = lb.interpolate(h2, h_b2, h_a2, s_b2, s_a2)
